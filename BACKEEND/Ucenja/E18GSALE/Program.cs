...
namespace Ucenja.E18GSALE
{
    public class Program
    {
        public Program() 
        {
            ...
            var o = new Obrada<string>();  // Obrada će moći obrađivati samo string

            o.PredmetObrade = "Osijek";
            //o.PredmetObrade = 67; // greška jer predmet obrade može biti samo string

            o.Posao();

            var obrada = new Obrada<int>();
            obrada.PredmetObrade = 67;
            // obrada.PredmetObrade = "Osijek";      // greška jer predmet obrade može biti samo int

            obrada.Posao();

            // rad s listama
            var lista = new List<string>();
            string[] gradovi = new string[10];  // u nizovima moramo reći koliko elemenata sadrži, za razliku od lista
           ...
           //  var eo = new EdunovaObrada<string>();  // Greška jer string ne naslijeđuje Entitet

            var os = new Obrada<Smjer>();  // ovo prolazi jer Smjer naslijeđuje Object
            ...
            Console.WriteLine(Zbroji(2,3));  // pozivam metodu

            // kreiranje "interne" metode pomoću lambda izraza
            // nalazimo se unutar konstruktora

            var Zbroj = (int i, int j) => i + j;

            Console.WriteLine(Zbroj(2,3));  // pozivam lokalnu varijablu Zbroj koja prima dva integera
            ...
            smjerovi[0].Naziv.EdunovaProvjera();  // EdunovaProvjera je ekstenzija koja će primiti bilo koji string i na njemu će nešto odraditi

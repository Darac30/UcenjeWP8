...
namespace Ucenja.E16Polimorfizam
{
    public class Program
    {
        ...
        public static void Ispisi(Osoba[] osobe)
        {
            ...
            {
                // ovo je polimorfizam!
                //nalazimo se u metodi koja priča s nizom osoba, pozivamo apstraktnu metodu "Pozdravi" koja
                // konzumira podatke iz potklasa, jer se u nizu osoba nalaze Polaznik i Predavač, 

using Newtonsoft.Json;  // 3rd party library koji omogućuje da se kreira json (javascript object notation) format, služi da bi objekte zapisao na disk
using PdfSharp.Drawing;  // Pdfsharp je library koji će ti dozvoliti da u C# generiraš PDF 
using PdfSharp.Pdf;
using System.Text;
...
namespace Ucenje.E19KonzolnaAplikacija
{
    public class Izbornik
    {
        ...
        public ObradaSmjer ObradaSmjer { get; set; }    // get set je OOP princip učahurivanja, getteri i setteri su metode
        ...
        public Izbornik() 
        {
            ...
            UcitajPodatke();  // metoda za učitavanje podataka
            PozdravnaPoruka();
            PrikaziIzbornik();
        }
